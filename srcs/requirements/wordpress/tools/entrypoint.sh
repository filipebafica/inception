...
wp core install --allow-root --url=https://localhost:443 --title="A very creative blog title" --admin_user=$MYSQL_USER --admin_password=$MYSQL_PASSWORD --admin_email=$MYSQL_USER@email.com
